-- Accept the legacy source_kind field as the canonical evidence-source fallback.
-- This remains fail-closed: direct publication, role corroboration and exact recipient match are required.
...
'Read-only evidence projection for the Phase 3E Outbound Governor, including strict legacy source_kind normalization.';
