-- Founder-governed Phase 4 raw prospect promotion.
-- Applied to canonical Supabase as migration 20260923111618.
-- REVIEW_READY is required. Promotion creates or links only a raw prospect.
-- It does not qualify, activate a buyer, send outbound, accept terms,
...
BEGIN
  ...
  INTO prospect_matches, prospect_id
...
COMMENT ON FUNCTION public.promote_buyer_scout_candidate_to_prospect(uuid, text) IS
  'Founder-governed Phase 4 raw prospect promotion. Requires REVIEW_READY; '
  'creates or links only a raw canonical prospect with buy_signal_score NULL. '
  'No qualification, buyer activation, outbound, commercial terms, payment or revenue authority.';
