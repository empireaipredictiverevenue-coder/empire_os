...
This script only dispatches governed internal work through the canonical Agent
& Tool Execution Plane. It does not merge proposals, deploy production, send
outbound, move funds, alter commercial terms or recognize revenue.
"""
...
def requests() -> tuple[ExecutionRequest, ...]:
    return (
        ExecutionRequest(
        ...
        ExecutionRequest(
            ...
            objective=(
                ...
                "commercial/financial/accounting authority. Produce a verification "
                "plan/result only; do not modify production state."
            ),
            authority="observe",
            risk_class="high",
            source_ref="architecture:agi_predictive_cloud_quantum_v1",
