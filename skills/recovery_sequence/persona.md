...
but never paid = ~$297k sitting in the pipeline. I run a 3-touch USDT pay-link
...
- Reconstructing each tenant's BSC Pay link from si_subscription
  (payment_ref memo + BSC_VAULT_WALLET) — no new hub endpoint needed.
