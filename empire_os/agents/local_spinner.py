...
NICHE_INFO = {
    ...
    # --- expanded to all 41 lanes (AEO coverage push) ---
    "commercial_roofing": ("commercial roofing leads", "business owners needing roof replacement or storm repair"),
    "disaster_restoration": ("disaster restoration leads", "property owners after fire/flood/storm damage"),
    "storm_damage": ("storm damage restoration leads", "homeowners with hail/wind damage needing claim + repair"),
    "sewage_cleanup": ("sewage cleanup leads", "property owners with backup or biohazard water"),
    "electrical": ("electrical leads", "homeowners needing wiring/panel/repair"),
    "real_estate": ("real estate leads", "buyers/sellers & agents needing local transactions"),
    "tax_prep": ("tax preparation leads", "individuals & SMBs needing filing help"),
    "accounting": ("accounting leads", "businesses needing bookkeeping/tax/CFO services"),
    "dental": ("dental leads", "patients needing cosmetic/general dental care"),
    "vision": ("vision care leads", "patients needing eye exams/glasses/lasik"),
    "addiction": ("addiction treatment leads", "individuals seeking rehab/recovery programs"),
    "hormone_therapy": ("hormone therapy leads", "patients seeking TRT/menopause care"),
    "weight_loss": ("weight loss leads", "patients seeking GLP-1/medical weight programs"),
    "pt_rehab": ("physical therapy leads", "patients needing rehab/post-op recovery"),
    "mortgage": ("mortgage leads", "homebuyers & refinancers seeking loans"),
    "insurance": ("insurance leads", "consumers needing auto/home/life coverage"),
    "investing": ("investing leads", "investors seeking advisory/wealth management"),
    "debt_relief": ("debt relief leads", "consumers seeking settlement/consolidation"),
    "legal_services": ("legal services leads", "individuals/firms needing attorneys"),
    "consulting": ("consulting leads", "businesses needing strategy/ops advisory"),
    "managed_it": ("managed IT leads", "SMBs needing outsourced IT support"),
    "cybersecurity": ("cybersecurity leads", "orgs needing threat/Compliance services"),
    "cloud": ("cloud services leads", "businesses needing migration/managed cloud"),
    "data_analytics": ("data analytics leads", "firms needing BI/analytics builds"),
    "software_dev": ("software development leads", "businesses needing custom apps/APIs"),
    "ai_automation": ("AI automation leads", "orgs needing workflow/agent automation"),
    "web_dev": ("web development leads", "businesses needing sites/apps/ecom"),
    "marketing": ("marketing leads", "brands needing growth/performance/SEO"),
    "staffing": ("staffing leads", "employers needing temp/direct-hire placement"),
}
