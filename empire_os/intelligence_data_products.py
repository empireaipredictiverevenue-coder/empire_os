...
DATA_PRODUCTS = (
    ...
    IntelligenceDataProduct(
        key="permit_intelligence_feed",
        name="Empire Permit Intelligence",
        category="permit_public_record_intelligence",
        source_nodes=("home_services", "property", "solar_energy", "hvac_climate"),
        deliverables=(
            "observed_permit_records",
            "project_property_contractor_evidence",
            "permit_trend_signals",
            "territory_demand_map",
            "permit_to_opportunity_evidence",
        ),
        delivery_modes=("api", "webhook", "export", "dashboard"),
        required_evidence=(
            "observed_permit_record",
            "source_provenance",
            "observed_at",
            "canonical_location_or_entity",
        ),
        compatible_usage_modes=(
            UsageMode.EVALUATION_SCORE,
            UsageMode.HOURLY_INTELLIGENCE,
    ...
    IntelligenceDataProduct(
        key="property_intelligence_monitor",
        name="Empire Property Intelligence",
        category="property_intelligence",
        source_nodes=("property", "volumetric", "natural_physical"),
        deliverables=(
            "property_entity_evidence",
            "permit_and_public_record_history",
            "observed_physical_or_event_signals",
            "portfolio_opportunity_map",
            "property_trigger_alerts",
        ),
        delivery_modes=("api", "webhook", "export", "dashboard", "report"),
        required_evidence=(
            "canonical_property_or_site",
            "source_provenance",
            "observed_at",
        ),
        compatible_usage_modes=(
    ...
    IntelligenceDataProduct(
        key="private_capital_intelligence",
        name="Empire Private Capital & Roll-Up Intelligence",
        category="private_capital_intelligence",
        source_nodes=("private_capital", "corporate", "market_intent", "property"),
        deliverables=(
            "sponsor_portfolio_graph",
            "rollup_market_map",
            "add_on_target_evidence",
            "portfolio_growth_opportunity_map",
            "consolidation_signals",
        ),
        delivery_modes=("api", "export", "dashboard", "report"),
        required_evidence=(
            "canonical_company_or_sponsor",
            "source_provenance",
            "observed_at",
        ),
        compatible_usage_modes=(
